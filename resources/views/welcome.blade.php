        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-12 mb-4 mb-lg-0">
                    ...
                    <h2 class="text-white display-4 fw-bold mb-4">
                ...
                <div class="col-lg-6 col-md-12 text-lg-end text-center">
                    <a href="#" class="social-icon me-3 mb-3 mb-lg-0"><i
    ...
    <div class="container-fluid text-center">
        ...
        <nav aria-label="Page navigation example mt-5 mb-5">
            <ul class="pagination justify-content-center gap-3">
                ...
                <li class="page-item">
                    <a class="page-link text-black badge p-3" href="#"
                        style="background-color: #cccccc">1337</a>
                </li>
                <li class="page-item">
                    <a class="page-link text-black badge p-3" href="#"
                        style="background-color: #cccccc">&gt;</a>
                    ...
                    <div class="contact-info">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p class="mb-0 small">email@email.com</p>
                            </div>
                        </div>
                    </div>
                </div>
